...
test('generateBreadcrumbs', () => {
  ...
  expect(generateBreadcrumbs('diphthongs', 0)).toStrictEqual([home, phonemes, { anchor: 'diphthongs', title: 'Diphthongs' }])
  expect(generateBreadcrumbs('consonants', 0)).toStrictEqual([home, phonemes, { anchor: 'consonants', title: 'Consonants' }])
  ...
  expect(generateBreadcrumbs('non-final', 0)).toStrictEqual([home, intonation, { anchor: 'non-final', title: 'Non-Final' }])
